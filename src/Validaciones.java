...
public class Validaciones {
    ...
    private String regexF = "\\d{1,2}-\\d{1,2}-\\{4}"; //Esta si jala, pero falla con fechas irreales
    private String getRegexF = "\\d([012][0-9]|3[012])"; //+ "-" + "\\d(0[1-9]|1[012])";
    ...
    public boolean validarFecha(String fecha){
        ...
        if (!patronF.matcher(fecha).matches() && fecha.length() == 2){
            return true;
        } else{
